...
if __name__ == "__main__":
    ...
    for seed in range(configs["train"]["seeds"]):
        ...
        list_target_models_init = os.listdir(target_path)
        if configs["audit"]["target_idx"] == "all":
            list_target_models = list_target_models_init
        elif configs["audit"]["target_idx"] == "ten":
            list_target_models = list_target_models_init[0:10]
        elif configs["audit"]["target_idx"] == "fifty":
            list_target_models = list_target_models_init[0:50]
        else:
