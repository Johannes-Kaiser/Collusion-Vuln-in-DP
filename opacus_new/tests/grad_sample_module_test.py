...
from opacus_new.grad_sample import GradSampleModule
from opacus_new.grad_sample.gsm_exp_weights import (
    API_CUTOFF_VERSION,
    GradSampleModuleExpandedWeights,
)
from opacus_new.grad_sample.linear import compute_linear_grad_sample
from opacus_new.grad_sample.utils import register_grad_sampler
